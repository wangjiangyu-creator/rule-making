export const recordDimensionsById = {
  ...
  'uncitral-model-law-electronic-transferable-records-2017': [
    'norm-entrepreneurship-drafting-power',
  ],
  'oecd-digital-trade-inventory-2023': [
    'norm-entrepreneurship-drafting-power',
  ],
  'uncitral-isds-working-group-iii': [
    'objective-setting',
    'agenda-setting',
    'coalition-consensus-building',
    'norm-entrepreneurship-drafting-power',
  ...
  'abbott-snidal-hard-soft-law-2000': [
    'objective-setting',
    'norm-entrepreneurship-drafting-power',
  ],
  'reich-lebow-good-bye-hegemony-2014': [
    'objective-setting',
  ],
  ...
  'brookings-cybersecurity-digital-trade-data-flows-2019': [
    'legitimacy-management',
    'norm-entrepreneurship-drafting-power',
  ],
  'carnegie-regime-complex-ai-2024': [
    'norm-entrepreneurship-drafting-power',
  ],
